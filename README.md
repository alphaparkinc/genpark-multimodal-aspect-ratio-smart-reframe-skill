# genpark-multimodal-aspect-ratio-smart-reframe-skill
...
**genpark-multimodal-aspect-ratio-smart-reframe-skill** is a deterministic, zero-dependency Python skill engineered for autonomous shortform video editing, audio silence pacing, generative canvas tiling, and viral hook optimization.

> **Executive Capability**: 16:9 to 9:16 dynamic speaker tracking & smart reframing bounding box coordinator (CapCut)
...
result = client.calculate_smart_reframe()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-multimodal-aspect-ratio-smart-reframe-skill": {
      "command": "python",
      "args": ["/path/to/genpark-multimodal-aspect-ratio-smart-reframe-skill/mcp_server.py"]
    }
  }
}
```
